package com.isuwang.soa.hello;
      ...
      public void validate(sayHello_result bean) throws TException{
            ...
            public static class sayHello<I extends com.isuwang.soa.hello.service.HelloService> extends SoaFunctionDefinition<I, sayHello_args, sayHello_result>
            {
              public sayHello()
              {
              super("sayHello", new SayHello_argsSerializer(),  new SayHello_resultSerializer(),false);
              }
              ...
              try {
                result.success = iface.sayHello(sayHello_args.content);
              ...
              @Override
              public CompletableFuture<sayHello_result> applyAsync(I iface, sayHello_args sayHello_args) {
              CompletableFuture<sayHello_result> future = CompletableFuture.supplyAsync(() -> apply(iface,sayHello_args));
              return future;
              }
